(function () {
  ...
  app.controller("createBrickController", createBrickController);

  app.component('createPool', {
    // Loads the component template
    templateUrl: '/commons/components/create-brick/create-brick.html',
    controller: 'createBrickController',
    controllerAs: "vm"
    });

    function createBrickController($scope, $state, utils, $rootScope) {
    var vm = this;
        // edit variables
        vm.newField = {};
        vm.editing = false;
