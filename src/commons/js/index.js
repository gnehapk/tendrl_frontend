...
(function() {
    ...
    function fetchConfigData() {
        ...
        return $http.get("../../config.json").then(function(response) {
            ...
            storageModule.config(function($stateProvider, $urlRouterProvider, $httpProvider, $locationProvider, configProvider, $injector) {
            ...
            storageModule.run(function($rootScope, $location, $http, $interval, $stateProvider, menuService, AuthManager, utils, eventStore, config) {
                ...
                function createStates(role) {
                 ...
                 $rootScope.$on("PermissionsChanged", function(role) {
                    createStates(role);
                });
