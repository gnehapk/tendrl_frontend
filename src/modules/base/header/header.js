(function() {
    ...
    /*@ngInject*/
    function headerController($rootScope, $state, $scope, $uibModal, AuthManager, utils, Notifications, userStore, AngularDetectBrowser, config) {
        ...
        vm.browser = AngularDetectBrowser.browser();
